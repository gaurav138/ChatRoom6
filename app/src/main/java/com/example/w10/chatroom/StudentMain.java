...
public class StudentMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = ii.getStringExtra("roll_no");

        if (roll_no.contains("14007"))
            year = "first year";
        else if (roll_no.contains("13007"))
            year = "second year";
        else if (roll_no.contains("12007"))
            year = "third year";
        else if (roll_no.contains("11007"))
            year = "fourth year";
        else
            Toast.makeText(StudentMain.this, "Roll no is not valid", Toast.LENGTH_SHORT).show();
        ...
        roota=FirebaseDatabase.getInstance().getReference().child("fourth year");
            ...
            Toast.makeText(StudentMain.this, "Invalid input", Toast.LENGTH_SHORT).show();
